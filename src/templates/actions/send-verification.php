...
<form class="woocommerce-form" method="post">
    ...
    <button type="submit" class="woocommerce-button button woocommerce-form-login__submit wp-element-button" name="resend" value="resend">Resend Verification</button>
</form>